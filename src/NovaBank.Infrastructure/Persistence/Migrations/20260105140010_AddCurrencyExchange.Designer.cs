...
namespace NovaBank.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260105140010_AddCurrencyExchange")]
    partial class AddCurrencyExchange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovaBank.Core.Entities.CurrencyPosition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("AverageCostRate")
                        .HasPrecision(18, 6)
                    ...
                    b.ToTable("currency_positions", (string)null);
                });

            modelBuilder.Entity("NovaBank.Core.Entities.CurrencyTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal?>("AvgCostBefore")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                    ...
                    b.Property<decimal>("NetTryAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("net_try_amount");

                    b.Property<decimal?>("PositionAfterAmount")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("position_after_amount");

                    b.Property<decimal?>("PositionBeforeAmount")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                    ...
                    b.Property<decimal?>("RealizedPnlTry")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
